...
export const userNavigation: NavSection[] = [
  { title: "Dashboard", href: "/user/dashboard" },
  {
    ...
    items: [
      ...
      { title: "Certificate of Residency", href: "/user/apply/certificate-of-residency" },
      { title: "Certificate of Indigency", href: "/user/apply/certificate-of-indigency" },
      { title: "Good Moral Character", href: "/user/apply/good-moral-character" },
      { title: "Barangay Business Clearance", href: "/user/apply/barangay-business-clearance" }
    ]
  },
...
export const adminNavigation: NavSection[] = [
  { title: "Overview", href: "/admin/overview" },
  {
    ...
    items: [
      ...
      { title: "Issued Documents", href: "/admin/requests-approvals/issued-documents" }
    ]
  },
  ...
  { title: "Blotter & Mediation", href: "/admin/blotter-mediation" },
  {
    title: "Health Center",
    items: [
      { title: "Appointments & Queue", href: "/admin/health-center/appointments" },
  ...
  { title: "Announcements & Broadcast", href: "/admin/announcements" },
  {
    ...
    items: [
      ...
      { title: "Document Templates", href: "/admin/settings/document-templates" }
    ]
  }
];
