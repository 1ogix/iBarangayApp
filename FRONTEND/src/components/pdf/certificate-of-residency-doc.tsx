...
export const CertificateOfResidencyDoc = ({
  firstName,
  middleInitial,
  lastName,
  age,
  ...
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <Text style={styles.body}>
        Based on the records of this barangay, the aforementioned resident has
        displayed good moral character and is known to be a law-abiding citizen.
