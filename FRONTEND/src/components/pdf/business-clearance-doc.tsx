...
// Register fonts from URLs so they are always reachable in serverless runtimes.
Font.register({
  family: "Poppins",
  fonts: [
    {
  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        {/* Title */}
        <Text style={styles.title}>Business Clearance</Text>
        {/* Body */}
        <Text style={styles.body}>To Whom It May Concern:</Text>
        <Text style={styles.body}>
          This is to certify that the business,{" "}
          <Text style={styles.bold}>{businessName}</Text>, owned and operated by{" "}
          <Text style={styles.bold}>
            {`${firstName} ${middleInitial}. ${lastName}`}
          </Text>{" "}
          with business address at <Text style={styles.bold}>{address}</Text>,
          Barangay {barangay}, {city}, has been found to be compliant with the
          requirements for the issuance of this clearance.
        </Text>
        <Text style={styles.body}>
          Based on the records of this office, the said business has no pending
          case and is of good standing within this community.
        </Text>
        <Text style={styles.body}>
          This <Text style={styles.bold}>BUSINESS CLEARANCE</Text> is issued
          upon the request of the owner for whatever legal purpose it may serve.
        </Text>
