            ...
            <div className="aspect-video w-full bg-muted flex items-center justify-center">
              {announcement.imageUrl ? (
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-muted-foreground" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l-1.586-1.586a2 2 0 00-2.828 0L6 14m6-6l2 2" />
                </svg>
              )}
            </div>
            ...
            {(onEdit || onDelete) && (
              <div className="flex space-x-2">
                {onEdit && (
                  <Dialog>
                    <DialogTrigger asChild>
                                        <Button variant="secondary" onClick={(e) => {e.stopPropagation(); onEdit(announcement)}}>Edit</Button>
                                      </DialogTrigger>
                                    </Dialog>
                                  )}
                                  {onDelete && (
                                      ...
                                      <AlertDialogContent>
                                        ...
                                        <AlertDialogFooter>
                                                          ...
                                                          <AlertDialogAction asChild>
                                                            <Button variant="destructive" onClick={() => onDelete(announcement)}>Delete</Button>
                                                          </AlertDialogAction>
                                        </AlertDialogFooter>
                                      </AlertDialogContent>
                                    </AlertDialog>                )}
