  ...
  if (isSubmitted) {
    return (
      <div className="space-y-6">
        <PageHeader
          title="Certificate of Indigency Request Submitted"
          description="Your request for a Certificate of Indigency has been received."
        />
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Request a certificate of indigency online."
      />
      <Card>
        <CardHeader>
