    ...
    <main className="flex flex-col">
      ...
      <section className="relative flex h-screen flex-col justify-center gap-8 bg-[url('/cebu_city_hall.jpg')] bg-cover bg-center px-5 py-20 text-white md:px-20 md:py-24">
        ...
        >
          ...
          <Button
            asChild
            className="bg-[#131E3A] text-white text-lg font-semibold px-6 py-4 rounded-xl shadow-lg transition-all duration-300 hover:bg-white hover:text-[#131E3A] border-2 border-[#131E3A]"
          >
          ...
          <Button
            asChild
            className="bg-[#1976D2]/10 text-white border-2 border-white text-lg font-semibold px-6 py-4 rounded-xl shadow-md transition-all duration-300 hover:bg-white hover:text-[#131E3A]"
          >
